...
public class URLDemo {
    //提取的数据存放到该目录下
    private static String savepath="E:/china_net/";
    //等待爬取的url
...
//        String strurl="http://search.dangdang.com/?key=%BB%FA%D0%B5%B1%ED&act=input";
        String strurl="http://photo.81.cn/";
        ...
        try {
            ...
            while((line=br.readLine())!=null){
            	...
            	while (matcher.find()) {
            		...
            		Matcher bbq=baby.matcher(temp);
            		if(bbq.find()) {
            		String temp1=bbq.group(0);
            		String temp2=temp1.substring(1,temp1.length()-1);
            		/*
            		if(temp2.indexOf("http:")<0&&temp2.indexOf("www.")<0) {
            				temp2="http://www.81.cn/"+temp2;
            		}
            		*/
            		if(temp2.indexOf("attachement")>0)
            		pw.println(temp2);
            		}

                }
               // pw.println(line);全部打印出来
                ...
                if(href.startsWith("http:")==false&&href.startsWith("https:")==false){
                	href="http://photo.81.cn/"+href;
                    /*
                    //输出该网页存在的链接
